...
public class Rule_6 extends Checker {
    public void checkID(ID id, String object) {
        ...
        switch(schemeId) {
            ...
            break;
            default:
                errors.setErrorMassage("Check " + object + ": Invalid schemeID (Blank/TXID/NIDN/CCPT/OTHR). Current schemeID = " + schemeId);
            break;
        }
    }

    public void checkGlobalID(GlobalID globalID, String object) {
