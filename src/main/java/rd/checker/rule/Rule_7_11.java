...
public class Rule_7_11 {
    public void checkAddress(String lineOne, String lineTwo, String citySubDivisionName, String cityName, String countryID, String postcodeCode, 
        List<String> citySubDivisionNames, List<String> cityNames, List<String> countryIDs, String object, ErrorMessage errors) {
        ...
        if (countryID.equals("TH")){
            checkThaiAddress(citySubDivisionName, cityName, citySubDivisionNames, cityNames, object, errors);
        } else {
            checkInternationalAddress(lineOne, lineTwo, countryID, countryIDs, object, errors);
        }
    ...
    private void checkThaiAddress(String citySubDivisionName, String cityName, List<String> citySubDivisionNames, List<String> cityNames, String object, ErrorMessage errors) {
    ...
    public void checkCountrySubDivisionID(String[] countrySubDivisionIDArray, List<String> countrySubDivisionIDs, String object, ErrorMessage errors) {
        for (String id : countrySubDivisionIDArray) {        
            checkCountrySubDivisionID(id, countrySubDivisionIDs, object, errors);
        }
    }

    public void checkCountrySubDivisionID(String countrySubDivisionID, List<String> countrySubDivisionIDs, String object, ErrorMessage errors) {
    ...
    private void checkInternationalAddress(String lineOne, String lineTwo, String countryID, List<String> countryIDs, String object, ErrorMessage errors) {
