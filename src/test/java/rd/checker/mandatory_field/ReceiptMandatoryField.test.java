...
class ReceiptMandatoryFieldTest {
    ...
    void TestCheckRequiredField() throws Exception {
        ...
        ReceiptMandatoryField rct = new ReceiptMandatoryField();
        rct.checkRequiredField(rootXml);
        String errorMessage = rct.getError().getErrorMessage();
        // Assert
